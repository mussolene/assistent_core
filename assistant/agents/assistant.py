...
- integrations: action sync_to_todo (title, list_id?) — создать задачу в Microsoft To-Do; list_todo_lists () — список списков To-Do; add_calendar_event (title, start_iso?, end_iso?) — в разработке. Для «добавь в To-Do», «создай задачу в Microsoft To-Do» вызови skill integrations с action=sync_to_todo и title.
