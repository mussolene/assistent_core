...
- [ ] **Telegram:** быстрая привязка — генерация кода/ссылки в Dashboard, привязка по `/start КОД` или magic-ссылке
...
- [ ] **/settings** (или /channels): бот возвращает ссылку на дашборд и краткую справку по настройкам
