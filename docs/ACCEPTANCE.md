...
- [ ] **Каналы:** кнопка «Проверить бота» возвращает OK и username
- [ ] **Модель:** сохранение URL, имени модели, опции LM Studio native; кнопка «Проверить подключение» — OK при доступной модели
