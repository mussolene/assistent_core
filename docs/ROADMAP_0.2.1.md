...
Связь с аналитикой: [docs/ANALYTICS_AND_ROADMAP_2026.md](ANALYTICS_AND_ROADMAP_2026.md).
...
- Интеграции Microsoft To-Do и Google Calendar — планируются в **0.2.2+** (см. ANALYTICS_AND_ROADMAP_2026.md, Фаза 2).
