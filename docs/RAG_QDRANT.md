...
| `conversation_memory`  | Память разговоров (8.1–8.3) | Индексация: хук оркестратора. Контекст: выборка по user_id/chat_id. Очистка: скилл memory_control (clear_conversation_memory), дашборд «Память» — кнопка «Очистить мою память разговоров». |
