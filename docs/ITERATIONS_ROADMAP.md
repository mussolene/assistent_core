...
**Сделано:** 1.1–10.8, **11.1** (поле priority), **12.1–12.2** (Фаза 2: To-Do OAuth/API, скилл integrations, дашборд, заглушка Calendar); прочие доработки: дефолт LM Studio (1234), метрики хоста на /system. Покрытие тестами 90% (ROADMAP §0).  
**Дальше (2026):** [docs/ANALYTICS_AND_ROADMAP_2026.md](ANALYTICS_AND_ROADMAP_2026.md) — Фаза 3 (MCP create_task/list_tasks/add_calendar_event/sync_task_to_todo), полная интеграция Google Calendar. По желанию — доработки UX, новые блоки.
