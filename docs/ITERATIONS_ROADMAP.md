...
**Сделано:** 1.1, 1.2, 1.3, 2.1, 2.2, 4.1, 4.2, 5.1, 5.2, 6.1, 6.2, 9.1, 9.3, 10.1, 10.2, 10.3; покрытие тестами 90% (ROADMAP §0).  
**Дальше (на выбор):** 3.1 (документы в боте), 4.3 (скилл send_email), 7.1 (index_repo), 8.1 (память разговоров), 9.2 (команды репо в боте), 10.5–10.8.
