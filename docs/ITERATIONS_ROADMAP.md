...
**Сделано:** 1.1, 1.2, 1.3, 2.1, 2.2, 5.1, 5.2, 6.1, 10.1, 10.2.  
**Дальше (на выбор):** 3.1 (документы в боте), 4.1 (Email в дашборде), 7.1 (index_repo), 8.1 (память разговоров), **9.2** (команды репо в боте), **10.3** (callback task:view в Telegram), **10.4** (воркер напоминаний).
