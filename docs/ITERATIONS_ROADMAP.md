...
**Сделано:** 1.1–10.8, **11.1** (поле priority, полуформализация задач); покрытие тестами 90% (ROADMAP §0).  
**Дальше (2026):** приоритеты и фазы — в [docs/ANALYTICS_AND_ROADMAP_2026.md](ANALYTICS_AND_ROADMAP_2026.md) (Фаза 0 — стабилизация; Фаза 1 — 11.1 выполнена; Фаза 2 — интеграции To-Do/Calendar, Фаза 3 — MCP-инструменты). По желанию — доработки UX, новые блоки.
