...
**Сделано:** 1.1, 1.2, 1.3, 2.1, 2.2, 3.1, 3.2, 3.3, 4.1, 4.2, 4.3, 5.1, 5.2, 6.1, 6.2, 7.1, 7.2, 8.1, 9.1, 9.3, 10.1–10.8; покрытие тестами 90% (ROADMAP §0).  
**Дальше (на выбор):** 8.2, 8.3, 9.2 (команды репо в боте).
