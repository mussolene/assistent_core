...
**Сделано:** 1.1, 1.2, 1.3, 2.1, 5.1, 5.2, 6.1.  
**Дальше (на выбор):** 2.2 (session/логин в дашборде), 3.1 (документы в боте), 4.1 (Email в дашборде), 6.2 (страница репо), 7.1 (index_repo), 8.1 (память разговоров).
