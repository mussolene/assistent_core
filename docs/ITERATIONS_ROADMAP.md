...
**Сделано:** 1.1–10.8, **11.1** (поле priority), **12.1–12.2** (Фаза 2: To-Do, дашборд, заглушка Calendar), **13.1–13.2** (Фаза 3: MCP add_calendar_event, sync_task_to_todo, документация сценариев); прочие доработки: дефолт LM Studio (1234), метрики хоста на /system. Покрытие тестами 90% (ROADMAP §0).  
**Дальше (2026):** [docs/ANALYTICS_AND_ROADMAP_2026.md](ANALYTICS_AND_ROADMAP_2026.md) — полная интеграция Google Calendar (OAuth, события), Фаза 4 (память и контекст). По желанию — доработки UX, новые блоки.
