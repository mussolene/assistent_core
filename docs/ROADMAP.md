...
**Версия 0.2.1 (минимализация, ядро):** план реализации — [docs/ROADMAP_0.2.1.md](ROADMAP_0.2.1.md). Текущая реализация остаётся под 0.1.x; шаблон GitHub Release для v0.1.0 — [.github/releases/v0.1.0.md](../.github/releases/v0.1.0.md).
