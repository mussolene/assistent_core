...
Документ описывает направления развития: многопользовательский режим с авторизацией, упрощённое спаривание Telegram, доработка Dashboard (мониторинг, динамика, команды бота, роли, первичная инициализация).
...
**Сейчас:** /start, /help, /reasoning и общий диалог с ассистентом.
...
Рекомендуемый порядок: **A + B** (вход и первый пользователь), затем **C** (удобное спаривание), **D** (удобный мониторинг и динамика), **E + F** (команды и перезапуск).
