...
**Статус выполнения:** Фаза 0, Фаза 1 (блок 11.1), Фаза 2 (To-Do + заглушка Calendar — блок 12) отражены в [ITERATIONS_ROADMAP.md](ITERATIONS_ROADMAP.md). Прочие доработки (дефолт LM Studio, метрики хоста на мониторинге) — там же.
